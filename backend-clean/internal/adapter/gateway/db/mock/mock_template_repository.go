...
type TemplateDBTX struct {
	templateRow *sqldb.Template
	detailRow   *sqldb.GetTemplateByIDRow
...
func NewTemplateDBTX(templateRow *sqldb.Template, detailRow *sqldb.GetTemplateByIDRow, rowErr, execErr error) *TemplateDBTX {
	return &TemplateDBTX{
...
func (m *TemplateDBTX) Exec(ctx context.Context, sql string, args ...interface{}) (pgconn.CommandTag, error) {
	return pgconn.CommandTag{}, m.execErr
}

func (m *TemplateDBTX) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) {
	if m.QueryErr != nil {
...
func (m *TemplateDBTX) QueryRow(ctx context.Context, sql string, args ...interface{}) pgx.Row {
...
func (m *templateRow) Value(i int) (interface{}, error)             { return nil, nil }
